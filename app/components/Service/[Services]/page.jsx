...
import styling from './services.module.css'
...
const Services = () => {
    ...
    {
        img: NLP, heading: "Heading 1", desc: `Lorem, ipsum dolor sit amet consectetur adipisicing elit.
    Quos unde labore rem modi ex tenetur nihil, illum facere aliquid obcaecatii` }]
    return (
        <>
            <section id={styling.section}>
                <p>Home &gt; Services &gt; {Services.split('%20').join(' ')}</p>
                <h1 style={{ fontSize: '2.5em', fontWeight: 600, color: '#6200EE' }}>{Services.split('%20').join(' ')}</h1>
